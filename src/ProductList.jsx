...
export default function ProductList({ onHomeClick }) {
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description:
            "Known for insect-repelling properties while adding a pleasant scent.",
          cost: "$20",
        },
        {
          name: "Basil",
  ...
  const isInCart = (name) => cartItems.some((it) => it.name === name);

  const handleAddToCart = (plant) => {
    if (isInCart(plant.name)) return;
          ...
          <div style={{ position: "relative" }}>
            ...
            <h1 className="cart">
                ...
                >
                    ...
                    <path
                        d="M42.3 72H221.7L195.3 164.4A15.9 15.9 0 0 1 179.9 176H84.1A15.9 15.9 0 0 1 68.7 164.4L32.5 37.8A8 8 0 0 0 24.8 32H8"
                        stroke="white"
                        strokeWidth="10"
                        strokeLinecap="round"
            ...
            <div key={cat.category} style={{ width: "100%" }}>
              ...
              <div className="product-list">
                {cat.plants.map((plant) => {
                  ...
                  return (
                    <div className="product-card" key={`${cat.category}-${plant.name}`}>
